...
<%@ include file="../../include/navigator.jsp" %>
	...
	<form action="member_modify.ing" method="post">
...
<table class="table table-striped table-bordered table-hover">
	...
	<tr>
		<td>아이디</td>
		<td><input type="text" name="m_id" value = "${login_result.m_id}" readonly/></td>
	</tr>
	<tr>
		<td>현재 비밀번호</td>
		<td><input type="password" name="m_pw" value = "${login_result.m_pw}" maxLength="15"></td>
	</tr>
	<hr>
	<tr>
		<td>변경할 비밀번호</td>
...
<input class="btn btn-secondary" type="submit" onClick="location.href='myInfo'" value="정보수정하기">
</form>
