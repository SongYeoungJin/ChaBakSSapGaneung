        ...
        <div>
            ...
            <div>
                <table>
                    <tr>
                        <th>제목</th>
                        <td><input style="width: 500px" type="text" id="rb_title" name="rb_title" /></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td><textarea style="width: 500px" rows="10" cols="10" id="rb_memo" name="rb_memo"></textarea></td>
                    </tr>
                    <tr>
                        <th>작성자</th>
                        <td><input style="width: 500px" type="text" id="rb_author" name="rb_author" /></td>
                    </tr>
                </table>
                <div>
...
function fn_addtoBoard(){
    ...
    form.action = "<c:url value='/Review/write.do'/>";
    form.submit();
}
