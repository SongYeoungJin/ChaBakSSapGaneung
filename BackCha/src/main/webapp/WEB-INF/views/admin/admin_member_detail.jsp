	...
	<div id="right-panel" class="right-panel">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item"><a class="nav-link active"
				data-toggle="tab" href="#one">구매내역</a></li>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="bootstrap-data-table"
							...
							<tbody>
								<tr align="center">
									<td onClick=" location.href='product.do'">1111111</td>
									<td><img src="resources/Picture/Light1.JPG"
								...
								<tr align="center">
									<td onClick=" location.href='product.do'">1111110</td>
									<td><img src="resources/Picture/Light1.JPG"
										width=50 height=50></td>
									<td>상품명</td>
									<td>10,000P</td>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="bootstrap-data-table"
							...
							<tbody>
								<tr align="center">
									<td onClick=" location.href='myReview'">2019-12-12</td>
									<td>푹신푹신한 담요</td>
									<td>123</td>
									<td>4.6</td>
								</tr>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="bootstrap-data-table"
							...
							<tbody>
								<tr align="center">
									<td onClick=" location.href='place'">2020-1-12</td>
									<td>삼척에서..</td>
									<td>강원도 삼척</td>
									<td>5.0</td>
								</tr>
