...
public class Cart_Dto {//��ٱ������̺�
	private int cart_num;		 		//������ȣ
	private int cart_o_num;				//�ֹ�������ȣ
	private int cart_m_num;				//�ֹ��ڰ�����ȣ
	private int cart_mar_num;			//��ǰ������ȣ
	private String cart_mar_name;		//��ǰ����
	private int cart_mar_price;			//��ǰ����
	private int cart_cnt;				//��ǰ����
